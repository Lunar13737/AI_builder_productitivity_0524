...
export const slides = [
  ...
  },
  {
    ...
    props: {
      ...
      eyebrow: "AI4E 基础设施",
      title: "LLM 有巨大潜力，\n工程系统需要基础设施建设",
      verdict: "AI 的工程生产力，不只需要更强的模型，而是需要模型与真实系统之间的基础设施。",
      items: [
        { label: "模型", title: "推理与规划", detail: "规划与创造" },
        { label: "表示", title: "状态转译", detail: "把 3D 世界转成可推理文本" },
        { label: "约束", title: "约束引擎", detail: "空间、连接、物理边界" },
        { label: "反馈", title: "反馈闭环", detail: "错误变成下一步信息" },
        { label: "仿真", title: "物理仿真验证", detail: "最终进入物理世界验收" },
      ],
    },
  },
  {
